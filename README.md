...
This has a 3 button interface, allowing you to change the time, pressing the left button will enter a mode where you can change the time, with the middle button incrementing the hours, and the right one incrementing minutes.
